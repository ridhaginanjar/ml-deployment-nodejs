...
async function predictClassification(model, image) {
    try {
        ...
        if(label === 'Melanocytic nevus') {
            // Referensi: https://www.klikdokter.com/penyakit/masalah-kulit/nevus
        ...
        if(label === 'Squamous cell carcinoma') {
            // Referensi: https://www.halodoc.com/kesehatan/karsinoma-sel-skuamosa
        ...
        if(label === 'Vascular lesion') {
            // Referensi: https://www.ssmhealth.com/cardinal-glennon/services/pediatric-plastic-reconstructive-surgery/hemangiomas
